...
# Run FixMisencodedBaseQualityReads (WDL auto generated from GATK Version 4.6.2.0-SNAPSHOT)
#
...
workflow FixMisencodedBaseQualityReads {
  ...
  call FixMisencodedBaseQualityReads {
  ...
  output {
    # Workflow Outputs                                  
    File FixMisencodedBaseQualityReadsoutput_arg = FixMisencodedBaseQualityReads.FixMisencodedBaseQualityReads_output_arg
    File? FixMisencodedBaseQualityReadsoutputIndex = FixMisencodedBaseQualityReads.FixMisencodedBaseQualityReads_outputIndex
  }
...
task FixMisencodedBaseQualityReads {
  ...
  command <<<
    ~{gatk} FixMisencodedBaseQualityReads \
  ...
  output {
    # Task Outputs                                      
    File FixMisencodedBaseQualityReads_output_arg = output_arg
    File? FixMisencodedBaseQualityReads_outputIndex = outputIndex
  }
