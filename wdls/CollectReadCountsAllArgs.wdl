...
# Run CollectReadCounts (WDL auto generated from GATK Version 4.6.0.0-SNAPSHOT)
#
...
workflow CollectReadCounts {
  ...
  parameter_meta {
    ...
    format: { description: "Output file format." }
...
task CollectReadCounts {
  ...
  command <<<
    ...
    ~{true='--format ' false='' defined(format)}~{sep=' --format ' format} \
