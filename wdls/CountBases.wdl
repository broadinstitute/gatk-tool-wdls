...
# Run CountBases (WDL auto generated from GATK Version 4.6.0.0-SNAPSHOT)
#
...
workflow CountBases {
  ...
  output {
    # Workflow Outputs                                  
    File CountBasesresults = CountBases.CountBases_results
  }
...
task CountBases {
  ...
  output {
    # Task Outputs                                      
    File CountBases_results = stdout()
  }
