...
# Run RevertBaseQualityScores (WDL auto generated from GATK Version 4.6.2.0-SNAPSHOT)
#
...
workflow RevertBaseQualityScores {
  ...
  output {
    # Workflow Outputs                                  
    File RevertBaseQualityScoresoutput_arg = RevertBaseQualityScores.RevertBaseQualityScores_output_arg
    File? RevertBaseQualityScoresoutputIndex = RevertBaseQualityScores.RevertBaseQualityScores_outputIndex
  }
...
task RevertBaseQualityScores {
  ...
  output {
    # Task Outputs                                      
    File RevertBaseQualityScores_output_arg = output_arg
    File? RevertBaseQualityScores_outputIndex = outputIndex
  }
