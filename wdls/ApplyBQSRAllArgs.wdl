...
# Run ApplyBQSR (WDL auto generated from GATK Version 4.2.0.0-SNAPSHOT)
#
...
#    global_qscore_prior                                Global Qscore Bayesian prior to use for BQSR                
#    interval_merging_rule                              Interval merging rule for abutting intervals                
#    intervals                                          One or more genomic intervals over which to operate         
#    preserve_qscores_less_than                         Dont recalibrate bases with quality scores less than this threshold
#    quantize_quals                                     Quantize quality scores to a given number of levels         
...
workflow ApplyBQSR {
  ...
  parameter_meta {
    ...
    emit_original_quals: { description: "Emit original base qualities under the OQ tag" }
    ...
    global_qscore_prior: { description: "Global Qscore Bayesian prior to use for BQSR" }
    ...
    preserve_qscores_less_than: { description: "Dont recalibrate bases with quality scores less than this threshold" }
    quantize_quals: { description: "Quantize quality scores to a given number of levels" }
...
task ApplyBQSR {
  ...
  command <<<
    ...
    ~{true='--emit-original-quals ' false='' defined(emit_original_quals)}~{sep=' --emit-original-quals ' emit_original_quals} \
    ...
    ~{true='--global-qscore-prior ' false='' defined(global_qscore_prior)}~{sep=' --global-qscore-prior ' global_qscore_prior} \
    ...
    ~{true='--quantize-quals ' false='' defined(quantize_quals)}~{sep=' --quantize-quals ' quantize_quals} \
